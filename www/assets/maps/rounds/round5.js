...
var room3colliders = {};
//gravestones
room3colliders.g1 = new smallCollisionSprite( 2.5 * tileWidth, 3 * tileHeight, 'grave4');
...
room3colliders.g5 = new smallCollisionSprite( 4.5 * tileWidth, 3 * tileHeight, 'grave5');
room3colliders.g6 = new smallCollisionSprite( 6.5 * tileWidth, 3 * tileHeight, 'grave2');
...
room4colliders.g2 = new smallCollisionSprite( 4.5 * tileWidth, 3.2 * tileHeight, 'grave1');
room4colliders.g3 = new smallCollisionSprite( 4.5 * tileWidth, 14 * tileHeight, 'grave1');
room4colliders.g4 = new smallCollisionSprite( 6.5 * tileWidth, 3.2 * tileHeight, 'grave4');
...
room4colliders.p2 = new smallCollisionSprite( 19.5 * tileWidth, 13 * tileHeight, 'pillarGone');
//king statue
